...
| 你有的东西 | 你想要的 | 从哪开始 |
|-----------|---------|-------|
| 代码 + 实验表格 + 笔记 | 完整英文 SCI 论文 | 全流程 |
| 实验 CSV + 方法描述 | 实验结果分析和论文 | Stage 3-4 |
| 中文论文初稿 | 英文 SCI 期刊投稿稿 | Stage 4d-4e |
| 英文初稿 | 润色 + 自审 + 模板输出 | Stage 4e-4g |
| 完整英文稿 | 质量检查和自批判 | Stage 4f |
| 零散笔记和想法 | 结构化研究简报 | Stage 1 |
