...
\begin{enumerate}
  \item [Innovation 1 contribution]. We design [Module A], which [mechanism]
        to achieve [capability] (Section~\ref{sec:method-innov1}).
  ...
  \item [Innovation 3 contribution]. We introduce [Module C], which [mechanism]
        to [purpose]. Experiments on [benchmarks] validate the method's
        effectiveness (Section~\ref{sec:experiments}).
\end{enumerate}
